...
//Created: 08/06/2020
//Last Recorded Run Time:66.29 Secs
...
from ( //Creates the main cohort from the t_S_emailsendtable
        ...
        join prod_edw.cust360.t_s_campaign ca on esend.campaignid = ca.eloqua_campaign_id and ca.sub_campaign_type = 'SUB'  
                                                                                             and ca.division = 'RC'
                                                                                             and ca.eloqua_campaign_id in ('24013', //Global Program Campaigns (always on campaigns)
                                                                                                                        '24260',
                                                                                                                        '24853',
                                                                                                                        '25198',
                                                                                                                        '24878',
